 ...
 *         &lt;element name="currentHealth" type="{http://ws.document.introsde/}measureBean" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="healthHistory" type="{http://ws.document.introsde/}measureBean" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PersonBean {
    ...
    protected List<MeasureBean> healthHistory;
     ...
     * 
     */
    public List<MeasureBean> getHealthHistory() {
        if (healthHistory == null) {
            healthHistory = new ArrayList<MeasureBean>();
        }
	...
	public String toString() {
		return "PersonBean [personId=" + personId + ", firstname=" + firstname + ", lastname=" + lastname
				+ ", birthday=" + birthday + ", currentHealth=" + currentHealth + ", healthHistory=" + healthHistory
				+ "]";
	}
